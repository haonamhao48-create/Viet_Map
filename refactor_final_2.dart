...
'''class _ProvinceTravelMap extends StatefulWidget {
  ...
  // 3. Update _ProvinceTravelMapState build to handle side panel and pass isCommuneMode
  content = content.replaceFirst(
'''            children: [
              SizedBox(
                width: 360,
...
'''          child: _TravelMapView(
  ...
  // 4. Rewrite _TravelMapView and _DetailedProvincePainter to use Geometry Cache
  final startTravelMapView = content.indexOf('class _TravelMapView extends StatelessWidget {');
  final endTravelMapView = content.indexOf('class _PlaceBubble extends StatelessWidget {');
...
''';
  ...
  // 5. Add _CommunesSidePanel
  if (!content.contains('class _CommunesSidePanel')) {
    content += '''

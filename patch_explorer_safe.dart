...
void main() {
  ...
  lines.insert(4, "import '../../data/models/commune_model.dart';");

  // Re-read because we need to search for text to find the right lines dynamically
  var content = lines.join('\n');

  // 2. Add selectedCommune
          ...
          Wrap(
            ...
            children: [
              if (commune.population > 0)
                _InfoPill(
                  label: 'Dân số',
                  value: _formatNumber(commune.population.toInt()),
                ),
